...
export function slimPrompt(prompt: ComposedPrompt & { logos?: GeneratedImage[]; feedback?: 'LIKE' | 'DISLIKE' }): ComposedPrompt & { logos?: GeneratedImage[]; feedback?: 'LIKE' | 'DISLIKE' } {
  return {
    ...prompt,
    logos: prompt.logos,
...
export function slimPipelineResult(result: {
  prompts: Array<ComposedPrompt & { logos?: GeneratedImage[]; feedback?: 'LIKE' | 'DISLIKE' }>;
  recommendations: unknown;
  bestPrompt: ComposedPrompt & { logos?: GeneratedImage[]; feedback?: 'LIKE' | 'DISLIKE' };
}) {
  return {
