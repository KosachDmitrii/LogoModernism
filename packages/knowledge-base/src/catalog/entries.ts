...
export const LOGO_CATALOG: LogoReference[] = [
  ...
  entry({ id: 'ref-mcdonalds', name: "McDonald's Golden Arches", designer: 'Jim Schindler', year: 1962, country: 'USA', chapter: 'geometric', section: 'round', industry: 'food', era: '1960s', markType: 'symbol', geometry: ['arch'], significance: 'Golden arches — architectural form as brand symbol.' }),
